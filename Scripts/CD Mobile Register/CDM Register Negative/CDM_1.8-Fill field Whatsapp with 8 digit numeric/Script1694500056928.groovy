...
Mobile.setText(findTestObject('Object Repository/Mobile A/Register page/Field_Whatsapp-number'), '08123456', 0)

Mobile.verifyElementText(findTestObject('Mobile A/Register page/Text_WhatsApp number must be 9-13 character-warning field Whatsapp'), 
