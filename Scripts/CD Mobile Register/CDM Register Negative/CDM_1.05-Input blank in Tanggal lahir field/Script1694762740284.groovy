...
Mobile.tap(findTestObject('Mobile A/Register page/Btn_Cancel_in_Date_icon'), 0)

Mobile.verifyElementText(findTestObject('Mobile A/Register page/Text_Birthdate cant be empty- warning tanggal lahir'), 'Birthdate cant be empty')
