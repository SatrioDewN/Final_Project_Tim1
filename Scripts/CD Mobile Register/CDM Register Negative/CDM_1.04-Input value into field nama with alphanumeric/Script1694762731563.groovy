...
Mobile.setText(findTestObject('Object Repository/Mobile A/Register page/Field_Nama'), 'Test123', 0)

Mobile.verifyElementText(findTestObject('Mobile A/Register page/Text_Name must be alphabetic - warning field name'), 'Name must be alphabetic')
