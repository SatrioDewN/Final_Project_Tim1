...
Mobile.setText(findTestObject('Object Repository/Mobile A/Register page/Field_Konfirmasi kata sandi'), 'Test12', 0)

Mobile.verifyElementText(findTestObject('Mobile A/Register page/text_Password not match - warning password and confirm password'), 
    'Password not match')
