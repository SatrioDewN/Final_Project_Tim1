...
WebUI.setText(findTestObject('Website/Event Page/Field_Search Event'), 'Day 4')

WebUI.verifyElementText(findTestObject('Website/Event Page/Verify_Search_Day 4 Workshop'), 'Day 4: Workshop')
