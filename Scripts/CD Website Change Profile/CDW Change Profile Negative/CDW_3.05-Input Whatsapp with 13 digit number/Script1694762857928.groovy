...
WebUI.verifyElementText(findTestObject('Website A/Edit profile page/Text_The whatsapp must be between 10 and 12'), 'The whatsapp must be between 10 and 12 digits.')
